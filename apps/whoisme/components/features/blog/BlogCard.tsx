...
export const BlogCard = ({ blog, onClick }: { blog: Blog; onClick: () => void }) => {
  return (
    <motion.div
      ...
      className="relative flex items-center justify-between bg-[#1e1e2e] rounded-xl border border-purple-500 shadow-md p-3 w-full max-w-3xl cursor-pointer group"
    >
      {/* Text Content */}
